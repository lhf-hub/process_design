...
export default {
  ...
  methods: {
    ...
    async getCompanyClient () {
      const data = await requests.get('/client/getCompanyClient')
      this.data = data
    },
    del (id) {
      requests.post('/client/delete', { id })
        .then(async response => {
          this.$message({
            message: '删除成功',
            type: 'success'
    ...
    async addClient () {
      await requests.post('/client/insert', this.form).then(async response => {
        this.$message({
          message: '添加成功',
          type: 'success'
        })
    ...
    async updateClient () {
      await requests.post('/client/update', this.form).then(async response => {
        this.$message({
          message: '修改成功',
          type: 'success'
        })
